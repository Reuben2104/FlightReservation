...
<body>
    ...
    // 1. add row to FlightTicket
    // 2. add row to Flight Reservation
    
    // Retrieve selected flight numbers from the request
    String departingFlightNumber = request.getParameter("departingFlight");
    String returningFlightNumber = request.getParameter("returningFlight");
    ...
    try {
        ...
        // Retrieve departing flight details
   ...
   <p style="font-size: 30px;">Fill out ticket information:</p>
	...
	<form action="ticketDisplay.jsp" method="POST">
        ...
        <select name="class_type" id="class_type">
            ...
            <option value="Business">Business (5% upcharge)</option>
            <option value="First Class">First Class (10% upcharge)</option>
        </select>
        ...
        %>
            ...
            <label for="class_type2">Class (returning flight):</label>
