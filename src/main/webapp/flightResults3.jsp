...
<html>
	...
	<form action="reserve.jsp" method="post"> <!-- Added form for submitting selected values -->
	    ...
	    Connection con = null;
		    ...
		    } else if (sortOption.equals("3")) { // sort by duration of flight
	...
	<table>
		...
		<tr>    
			...
			<tr>
		        <td><input type="radio" name="departingFlight" value="<%= flightNumber %>"></td> <!-- Added radio button -->
		        <td><%= flightNumber %></td>
		        <td><%= printDate %></td>
		        <td><%= printAirline %></td>
		        <td><%= departure %></td>
		...
		<tr>    
			...
			<tr>
		        <td><input type="radio" name="returningFlight" value="<%= flightNumber %>"></td> <!-- Added radio button -->
		        <td><%= flightNumber %></td>
		        <td><%= printDate %></td>
		        <td><%= printAirline %></td>
		        <td><%= departure %></td>
